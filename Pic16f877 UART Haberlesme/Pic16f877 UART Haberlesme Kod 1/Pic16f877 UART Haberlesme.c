...
char alinan[10],verilen[10]; //Alýnan ve ver adýnda string dizi tanýmlýyoruz.alinan karþý mikrodenetleyiciden alýnan veri,verilen ise gönderilen veri.
...
delay_ms(1000);
puts(verilen); //verilen adlý diziyi puts komutu ile karþý gönderiyor.
}
